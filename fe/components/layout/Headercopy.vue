<template>
  <!-- bg-white -->
  <header
    class="  absolute top-[10vh]  justify-center  pb-10  leading-snug uppercase   "
  >
  ...
  <nav class="headtoplinks  p-20 linktextmb text-[1.2rem] justify-between flex items-center">
